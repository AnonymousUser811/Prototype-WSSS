...
from models.UNet_o import Unet_o
from models.UNet_p import Unet_prototype
from models.ViGUNet import ViGUNet
...
def build_UNet(args):
    ...
    #     return ViGUNet()
    # elif args.model == 'Unet_p':
    #     return Unet_prototype(in_ch=1, out_ch=4)
    # elif args.model == 'Unet_o':
    #     return Unet_o(in_ch=1, out_ch=4)
    return Unet_prototype(in_ch=1, out_ch=4)
